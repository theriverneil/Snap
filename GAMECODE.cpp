...
#pragma HLS INTERFACE m_axi depth=2073600 port=out_data offset=slave
	...
	pixel_type on_table[156]; //white signifies end, checked frequently             ///////Initialise the arrays for Card detection - Neil
	pixel_type possible_candidates[156]; //checked frequently												////////
	pixel_type possible_candidates_count[52]; // Array to count candidates									///////
...
//////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////
	//////////////pixel_type card_presets[156];  			//white signifies empty slot///////////////////////////////////
  ////////////////pixel_type on_table[156]; //white signifies end, checked frequently///////////////////////////////////          MOVED TO OUTSIDE, E.G. TOP OF CODE, INITIALISED AT THE START
  /////////////////pixel_type possible_candidates[156]; //checked frequently////////////////////////////////////////////////
...
void initialise255(pixel_type pixel_array[]){     //////////
  for(int i = 0; i < 156; i++){									 //////////  INITIALISE 255
    pixel_array[i] = 156;
  }
}
